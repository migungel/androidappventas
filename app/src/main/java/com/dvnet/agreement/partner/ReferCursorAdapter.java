...
public class ReferCursorAdapter extends CursorAdapter {

    public ReferCursorAdapter(Context context, Cursor c) {
        super(context, c, 0);
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        return inflater.inflate(R.layout.list_item_refer, viewGroup, false);
    }
